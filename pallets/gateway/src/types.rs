...
#[derive(
	Encode, Decode, Default, PartialEq, Eq, Clone, Copy, RuntimeDebug, MaxEncodedLen, TypeInfo,
)]
...
#[derive(Encode, Decode, PartialEq, Eq, Clone, RuntimeDebug, MaxEncodedLen, TypeInfo)]
#[cfg_attr(feature = "std", derive(Serialize, Deserialize))]
...
#[derive(Encode, Decode, PartialEq, Eq, Clone, RuntimeDebug, MaxEncodedLen, TypeInfo)]
#[cfg_attr(feature = "std", derive(Deserialize, Serialize))]
pub enum DepositAddrInfo<T: AsRef<[u8]> + MaxEncodedLen + TypeInfo> {
