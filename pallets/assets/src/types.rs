...
define_enum!(
	#[derive(PartialEq, Eq, Ord, PartialOrd, Clone, Copy, Encode, Decode, RuntimeDebug, MaxEncodedLen, TypeInfo)]
...
pub struct TotalAssetInfo<AssetInfo, Balance> {
	pub info: AssetInfo,
	pub balance: Balance,
	pub is_online: bool,
